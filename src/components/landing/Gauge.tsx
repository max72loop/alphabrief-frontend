...
// Re-export pour compat des consommateurs existants qui importent depuis
// "@/components/landing/Gauge". Les Server Components doivent préférer
// importer directement depuis "@/lib/design" pour éviter le franchissement
// de frontière client/server.
export { C, serif, sans, mono, SCORE_THRESHOLDS, scoreColor, scoreLabel };
